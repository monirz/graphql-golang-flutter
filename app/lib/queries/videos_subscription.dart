...
class VideoFeed extends StatelessWidget {
  ...
  // List<Video> videoList; 
    Video video = new Video();
      VideoQueryListState vq = new VideoQueryListState();



  // VideoFeed({this.listWidget,this.videoList});
  ...
  Widget build(BuildContext context) {
    ...
    return Subscription<Map<String, dynamic>>(
      ...
      builder: ({dynamic loading, dynamic payload, dynamic error}) {
        ...
        if (payload == null) {
          print('the payload is null');
        }

         Map<String, dynamic> newVideo = payload;
              video.name = newVideo['name'];
              
      print("new video >>>>> debug ");
      vq.addTodoItem(video);
